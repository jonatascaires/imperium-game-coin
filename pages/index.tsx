  ...
  return (
    <>
      ...
      <div className={`flex absolute top-2 h-8 justify-center items-center gap-6 font-OdibeeSans w-screen text-xl text-white ${activePage > 0 && 'hidden'}`}>
        ...
        <a href="https://www.pinksale.finance/#/launchpad/0x2236C22F28Ab2308FbF3b51E62Fd9366599427cc?chain=BSC" target="_blank"><div className="cursor-pointer animate-pulse opacity-80 hover:opacity-100">{language === 'en' ? 'Presale' : 'Pré-venda'}</div></a>
      </div>
